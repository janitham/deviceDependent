...
class AYAH {
	...
	protected $ayah_publisher_key = 'aa3a260075b5f2c6873e62d182a361ce235d5397';
	protected $ayah_scoring_key = 'e01dd983bc24dbe8ea7e37e613b676197613342c';
	 ...
	 * @return boolean
	 */
	public function scoreResultWrapper($session_secret){
		$result = false;
		if ($session_secret) {
			$fields = array(
